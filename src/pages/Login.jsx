...
const Authentication = () => {
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    try {
      ...
      showMessage(err.response?.data?.detail ?? "Signup failed", "error");
    }
  };
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/", {
        state: { flashMessage: "Login successful!", type: "success" },
      });
    } catch (err) {
      console.error("Login error:", err);
      showMessage(err.response?.data?.detail ?? "Login failed", "error");
    }
  };
