...
import { Sun, Moon, Leaf, Menu, House, BookA, LogOut } from "lucide-react";
...
const Nav = () => {
  ...
  // Navigation items - edit here to change both PC and mobile
  const navItems = useMemo(() => [
    ...
    //   ? [
          ...
          },
          {
            ...
            label: "About",
            onClick: () => {
              // Check if we're on the landing page first
              if (window.location.pathname === "/landing") {
                ...
                // If not on landing page, navigate to landing page with about hash
